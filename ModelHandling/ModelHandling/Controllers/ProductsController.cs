...
namespace ModelHandling.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductName,ProductDescription,Price,ImageUrl,CategoryId")] Products products, IFormFile file )
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductName,ProductDescription,Price,ImageUrl,CategoryId")] Products products)
        {
            if (id != products.Id)
            {
                return NotFound();
